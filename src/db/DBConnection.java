...
// This interface defines the methods that its implementation class should complete in order to communicate to database.
public interface DBConnection {
	...
	/**
	 * Register a user into database. Return whether the registration is successful.
	 * 
	 * @param userId
	 * @param password
	 * @return boolean
