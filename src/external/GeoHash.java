...
// Class that is used to generate a hash code given a set of lat & lon.
// b/c: TicketMaster will soon stop using latlong in the request url for searching, but will use geoPoint instead,
// which is what this class will generate.
