...
//Recommendation based on geo distance and similar categories (content-based recommendation).
public class GeoRecommendation {
	...
	public List<Item> recommendItems(String userId, double lat, double lon) {
		...
		// Step 2, get all categories while recording the count of each category,
		...
		// sort by count (events that had heavier category count will be displayed first), 
		...
		// Step 3, search based on category, filter out already-favorite items.
