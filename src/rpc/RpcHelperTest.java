...
// Test class for testing methods in RpcHelper.java
public class RpcHelperTest {
	...
	public void testGetJSONArray() throws JSONException {
		...
		Item one = new ItemBuilder().setItemId("one").setRating(5).setCategories(category).setDistance(33.33).build();
		Item two = new ItemBuilder().setItemId("two").setRating(5).setCategories(category).setDistance(33.33).build();
